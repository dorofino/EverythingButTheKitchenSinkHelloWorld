using EverythingButTheKitchenSinkHelloWorldLibrary.Models;
...
public class Messages : IMessages
{
    ...
    private string LookUpCustomText(string key, string language)
    {
        ...
        try
        {
            ...
            if (messages is null)
            {
                throw new NullReferenceException("The specified language was not found in the CustomText.json");
            }
        ...
        {
            _log.LogError(ex, "Error looking up the CustomText.json", ex);
            throw;
        }
    }
}